...
cells.append(nbf.v4.new_code_cell("%pip install --quiet --no-cache-dir --upgrade --no-deps --force-reinstall \"risk-pipeline[ml,notebook] @ git+https://github.com/selimoksuz/risk-model-pipeline.git@development\""))
