...
class ModelRegistry:
    ...
    def _load_registry(self):
        ...
        if self.metadata_file.exists():
            ...
            self.metadata = {"models": {}, "current_version": None, "champion": None, "challengers": []}
...
class ModelComparator:
    ...
    def ab_test(
        ...
        results["winner"] = "challenger" if results["challenger"]["auc"] > results["champion"]["auc"] else "champion"
